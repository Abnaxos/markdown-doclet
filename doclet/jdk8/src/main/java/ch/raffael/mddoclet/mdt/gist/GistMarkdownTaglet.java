...
package ch.raffael.mddoclet.mdt.gist;
...
import ch.raffael.mddoclet.mdtaglet.PredefinedWhiteSpacePreserver;
import ch.raffael.mddoclet.mdtaglet.WhiteSpacePreserver;
import ch.raffael.mddoclet.mdtaglet.argval.ArgumentPredicate;
import ch.raffael.mddoclet.mdtaglet.argval.PredefinedArgumentPredicates;

import static ch.raffael.mddoclet.mdtaglet.argval.IndexFilter.at;
import static ch.raffael.mddoclet.mdtaglet.argval.PredefinedArgumentPredicates.isInteger;
import static ch.raffael.mddoclet.mdtaglet.argval.PredefinedArgumentPredicates.options;
import static ch.raffael.mddoclet.mdtaglet.argval.PredefinedArgumentValidators.allOf;
import static ch.raffael.mddoclet.mdtaglet.argval.PredefinedArgumentValidators.anyOf;
import static ch.raffael.mddoclet.mdtaglet.argval.PredefinedArgumentValidators.argumentTypeValidator;
import static ch.raffael.mddoclet.mdtaglet.argval.PredefinedArgumentValidators.atLeast;
...
public final class GistMarkdownTaglet extends MarkdownTagletBase {
    ...
    public void afterOptionsSet() throws Exception {
        ...
        engine.init(loadVelocityProperties("/ch/raffael/mddoclet/mdt/gist/mdt-gist-velocity.properties"));
        this.template = engine.getTemplate("/ch/raffael/mddoclet/mdt/gist/mdt-gist-template.vm");
    }
