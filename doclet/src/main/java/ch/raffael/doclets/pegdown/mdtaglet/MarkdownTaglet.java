 ...
 * + the {@link #render(List)} or {@link #renderRaw(String)} method, which should create markdown/pegdown code.
 *
 */
public interface MarkdownTaglet {
     ...
     *
     * @see ch.raffael.doclets.pegdown.mdtaglet.MarkdownTaglet.Option
     */
