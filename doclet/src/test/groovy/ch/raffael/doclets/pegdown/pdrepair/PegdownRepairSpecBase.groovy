...
/**
 * PegdownRepairSpecBase contains specification for ... .
 */
abstract class PegdownRepairSpecBase extends Specification {
    ...
    protected static String applyPegdownParser(String markdown) {
