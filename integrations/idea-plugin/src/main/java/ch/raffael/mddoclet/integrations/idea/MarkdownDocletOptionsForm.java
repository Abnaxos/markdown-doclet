 ...
 */
public class MarkdownDocletOptionsForm {

    private JPanel root;
    private JCheckBox enableMarkdownDocletCheckBox;
    ...
    private MarkdownOptions projectOptions;
    ...
    public MarkdownDocletOptionsForm(Project project) {
        ...
        enableMarkdownDocletCheckBox.addItemListener(new ItemListener() {
            @Override
            public void itemStateChanged(ItemEvent e) {
                synchronized (MarkdownDocletOptionsForm.this) {
                    projectOptions.enabled = enableMarkdownDocletCheckBox.isSelected();
                }
            }
        });
    ...
    public synchronized void reset() {
        ...
        UIUtil.invokeLaterIfNeeded(new Runnable() {
            public void run() {
                enableMarkdownDocletCheckBox.setSelected(projectOptions.enabled);
            }
        });
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    {
        root = new JPanel();
        root.setLayout(new com.intellij.uiDesigner.core.GridLayoutManager(2, 4, new Insets(0, 0, 0, 0), -1, -1));
        ...
        enableMarkdownDocletCheckBox = new JCheckBox();
        enableMarkdownDocletCheckBox.setText("Enable Markdown Doclet");
        root.add(enableMarkdownDocletCheckBox, new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_WEST, com.intellij.uiDesigner.core.GridConstraints.FILL_NONE, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK | com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        optionsButton = new JButton();
        optionsButton.setText("Options...");
        root.add(optionsButton, new com.intellij.uiDesigner.core.GridConstraints(0, 3, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK | com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final com.intellij.uiDesigner.core.Spacer spacer1 = new com.intellij.uiDesigner.core.Spacer();
        root.add(spacer1, new com.intellij.uiDesigner.core.GridConstraints(0, 2, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        final JScrollPane scrollPane1 = new JScrollPane();
        root.add(scrollPane1, new com.intellij.uiDesigner.core.GridConstraints(1, 0, 1, 4, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER, com.intellij.uiDesigner.core.GridConstraints.FILL_BOTH, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK | com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_SHRINK | com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
        modulesTable = new JTable();
        modulesTable.setFillsViewportHeight(true);
        scrollPane1.setViewportView(modulesTable);
    }
    ...
    private static enum ModuleConfComboBoxEntry {
        PROJECT("Use Project Settings") {
            @Override
            boolean matches(MarkdownOptions options) {
        ...
        abstract boolean matches(MarkdownOptions options);
    }
