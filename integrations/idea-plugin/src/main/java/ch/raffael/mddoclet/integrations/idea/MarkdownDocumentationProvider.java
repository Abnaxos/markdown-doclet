...
/**
 * A documentation provider that renders the JavaDoc comments using Markdown.
 *
 * @author <a href="mailto:herzog@raffael.ch">Raffael Herzog</a>
 */
public class MarkdownDocumentationProvider extends JavaDocumentationProvider {
    ...
    public MarkdownDocumentationProvider() {
    }
