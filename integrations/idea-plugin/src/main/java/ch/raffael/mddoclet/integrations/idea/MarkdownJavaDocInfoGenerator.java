 ...
 */
public class MarkdownJavaDocInfoGenerator extends JavaDocInfoGenerator {

    private final Project project;
    private final PsiElement element;
    private final DocCommentProcessor processor;

    public MarkdownJavaDocInfoGenerator(Project project, PsiElement element, DocCommentProcessor processor) {
