 ...
 * currently no way to do this using the command line. Extending the PegdownDoclet is
 * easy, though, it's been written with that in mind. See the JavaDocs and sources for
 * details on this.
 *
 *
 * Doclet Options
